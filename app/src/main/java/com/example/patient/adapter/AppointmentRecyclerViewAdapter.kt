...
class AppointmentRecyclerViewAdapter (items: List<AppointmentVO>, listener: ListAppointmentFragment.OnListAppointmentFragmentInteractionListener)
    : RecyclerView.Adapter<AppointmentRecyclerViewAdapter.AppointmentViewHolder>() {

    private var mValues: List<AppointmentVO> = items
    ...
    inner class AppointmentViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        lateinit var mItem: AppointmentVO
